...
public class Q2Test {
	...
	public void testSimpleReducer() {
		...
		reduceDriver.withOutput(new Text("United States,SE.PRM.ENRR.FE"), new DoubleWritable(5.0));
	...
	public void testMultipleReducer() {
		...
		list.add(new DoubleWritable(25.0));
		list.add(new DoubleWritable(30.0));
		list.add(new DoubleWritable(26.0));
		list.add(new DoubleWritable(24.0));
		list.add(new DoubleWritable(35.0));
		list.add(new DoubleWritable(50.0));
		
		reduceDriver.withInput(new Text("United States,USA,SE.PRM.ENRR.FE"), list);
		reduceDriver.withOutput(new Text("United States,SE.PRM.ENRR.FE"), new DoubleWritable(26.0));
		reduceDriver.runTest();
	}
	...
	public void testMapReduce() {
		...
		mapReduceDriver.addOutput(new Text("United States,SE.PRM.ENRR.FE"), new DoubleWritable(10.0));
	...
	public void testRealMapReducerLarge() {
		...
		mapReduceDriver.addInput(new LongWritable(0), new Text(input));
		mapReduceDriver.addOutput(new Text("United States,SE.TER.ENRR.FE"), new DoubleWritable(13.437360000000012));
